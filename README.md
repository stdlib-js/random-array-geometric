...
```javascript
geometric = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-geometric@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-array-geometric/tags). For example,

```javascript
geometric = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-geometric@v0.0.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var geometric = require( 'path/to/vendor/umd/random-array-geometric/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-array-geometric@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-array-geometric.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-array-geometric

[test-image]: https://github.com/stdlib-js/random-array-geometric/actions/workflows/test.yml/badge.svg?branch=v0.0.1
[test-url]: https://github.com/stdlib-js/random-array-geometric/actions/workflows/test.yml?query=branch:v0.0.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-array-geometric/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-array-geometric?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-array-geometric.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-array-geometric/main
...
[branches-url]: https://github.com/stdlib-js/random-array-geometric/blob/main/branches.md

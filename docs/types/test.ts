...
{
	random( 10, 0.01 ); // $ExpectType RandomArray
	random( 10, 0.01, {} ); // $ExpectType RandomArray
}

// The compiler throws an error if the function is provided a first argument which is not a number...
{
	random( '5', 0.01 ); // $ExpectError
	random( true, 0.01 ); // $ExpectError
	random( false, 0.01 ); // $ExpectError
	random( null, 0.01 ); // $ExpectError
	random( [], 0.01 ); // $ExpectError
	random( {}, 0.01 ); // $ExpectError
	random( ( x: number ): number => x, 0.01 ); // $ExpectError
...
{
	random( 10, 0.01, '5' ); // $ExpectError
	random( 10, 0.01, 5 ); // $ExpectError
	random( 10, 0.01, true ); // $ExpectError
	random( 10, 0.01, false ); // $ExpectError
	random( 10, 0.01, [] ); // $ExpectError
	random( 10, 0.01, ( x: number ): number => x ); // $ExpectError
}

// The compiler throws an error if the function is provided a `dtype` option which is not a supported data type...
{
	random( 10, 0.01, { 'dtype': 123 } ); // $ExpectError
	random( 10, 0.01, { 'dtype': 'abc' } ); // $ExpectError
	random( 10, 0.01, { 'dtype': null } ); // $ExpectError
	random( 10, 0.01, { 'dtype': [] } ); // $ExpectError
	random( 10, 0.01, { 'dtype': {} } ); // $ExpectError
	random( 10, 0.01, { 'dtype': ( x: number ): number => x } ); // $ExpectError
}
...
{
	random.factory( 0.01 ); // $ExpectType UnaryFunction
	random.factory( 0.01, { 'copy': false } ); // $ExpectType UnaryFunction
...
{
	const fcn1 = random.factory( 0.01 );
	fcn1( 10 ); // $ExpectType RandomArray

	const fcn2 = random.factory();
	fcn2( 10, 0.01 ); // $ExpectType RandomArray
}
...
{
	random.factory( null ); // $ExpectError
	random.factory( 0.01, null ); // $ExpectError
}
...
{
	random.factory( 0.01, { 'prng': 123 } ); // $ExpectError
	random.factory( 0.01, { 'prng': 'abc' } ); // $ExpectError
...
{
	random.factory( 0.01, { 'seed': true } ); // $ExpectError
	random.factory( 0.01, { 'seed': 'abc' } ); // $ExpectError
	random.factory( 0.01, { 'seed': null } ); // $ExpectError
	random.factory( 0.01, { 'seed': [ 'a' ] } ); // $ExpectError
	random.factory( 0.01, { 'seed': {} } ); // $ExpectError
	random.factory( 0.01, { 'seed': ( x: number ): number => x } ); // $ExpectError
...
{
	random.factory( 0.01, { 'state': 123 } ); // $ExpectError
	random.factory( 0.01, { 'state': 'abc' } ); // $ExpectError
...
{
	random.factory( 0.01, { 'copy': 123 } ); // $ExpectError
	random.factory( 0.01, { 'copy': 'abc' } ); // $ExpectError
	random.factory( 0.01, { 'copy': null } ); // $ExpectError
	random.factory( 0.01, { 'copy': [] } ); // $ExpectError
	random.factory( 0.01, { 'copy': {} } ); // $ExpectError
	random.factory( 0.01, { 'copy': ( x: number ): number => x } ); // $ExpectError
...
{
	random.factory( 0.01, { 'dtype': 123 } ); // $ExpectError
	random.factory( 0.01, { 'dtype': 'abc' } ); // $ExpectError
	random.factory( 0.01, { 'dtype': null } ); // $ExpectError
	random.factory( 0.01, { 'dtype': [] } ); // $ExpectError
	random.factory( 0.01, { 'dtype': {} } ); // $ExpectError
	random.factory( 0.01, { 'dtype': ( x: number ): number => x } ); // $ExpectError
...
{
	random.factory( 0.01, {}, {} ); // $ExpectError
}
...
// The compiler throws an error if the function returned by the `factory` method is provided invalid arguments...
{
	...
	const fcn2 = random.factory();
	fcn2( true, 0.01 ); // $ExpectError
	fcn2( false, 0.01 ); // $ExpectError
	fcn2( '5', 0.01 ); // $ExpectError
	fcn2( [], 0.01 ); // $ExpectError
	fcn2( {}, 0.01 ); // $ExpectError
	fcn2( ( x: number ): number => x, 0.01 ); // $ExpectError
...
// The compiler throws an error if the function returned by the `factory` method is provided a `dtype` option which is not a supported data type...
{
	...
	fcn1( 0.01, { 'dtype': 123 } ); // $ExpectError
	fcn1( 0.01, { 'dtype': 'abc' } ); // $ExpectError
	fcn1( 0.01, { 'dtype': null } ); // $ExpectError
	fcn1( 0.01, { 'dtype': [] } ); // $ExpectError
	fcn1( 0.01, { 'dtype': {} } ); // $ExpectError
	fcn1( 0.01, { 'dtype': ( x: number ): number => x } ); // $ExpectError

	const fcn2 = random.factory( 0.01 );
